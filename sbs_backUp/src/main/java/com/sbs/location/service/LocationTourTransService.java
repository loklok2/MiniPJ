...
import com.sbs.location.repository.LocationTourTransRepository;

@Service
public class LocationTourTransService {
    
    @Autowired
    private LocationTourTransRepository LocationTourTransRepo;
